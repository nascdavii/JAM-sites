            ...
            <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <p className="text-lg text-[#4A5568] leading-[1.85] mb-8">
                        Realizamos vistorias técnicas, levantamentos de campo e
                        georreferenciamento em toda Salvador e Região Metropolitana.
                        Para propriedades rurais em outras regiões da Bahia,
                    ...
                    <a
                        ...
                        className="inline-flex items-center gap-2 text-sm font-semibold text-[#B07D46] hover:text-[#8A6237] transition-colors"
                    >
                ...
                >
                    <iframe
                        title="Área de atendimento Martins Engenharia — Salvador, BA"
